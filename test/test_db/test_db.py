...
class TestDb(unittest.TestCase):
    ...
    @staticmethod
    def get_connection():
        """Return connection to listof database."""

        connection_string = 'driver={PostgreSQL Unicode};server=db;port=5432;database=listof;uid=postgres;pwd=password;'  # Should be moved to config file
